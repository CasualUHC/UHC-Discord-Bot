...
poll_options = [
    create_option(
        name="poll_title", description="poll title", required=True, option_type=3
    ),
    create_option(
...
scoreboard_options = create_option(
    ...
    description="stat",
    choices=[
        create_choice(name="damage taken", value="damage taken"),
        create_choice(name="damage dealt", value="damage dealt"),
...
scoreboard_show_all = create_option(
    name="show_all", required=False, option_type=5, description="show all players"
)

server_prefix = create_option(
    name="server_prefix", required=True, option_type=3, description="server prefix"
)

server_name = create_option(
    name="server_name", required=True, option_type=3, description="server name"
)

server_logo = create_option(
    name="server_logo", required=True, option_type=3, description="link to server logo"
)
...
server_colour = create_option(
    ...
    choices=[
        ...
        create_choice(name="Dark Green", value="dark_green"),
        create_choice(name="Green", value="green"),
        create_choice(name="Aqua", value="aqua"),
        create_choice(name="Dark Aqua", value="dark_aqua"),
        create_choice(name="Dark Blue", value="dark_blue"),
        create_choice(name="Blue", value="blue"),
        create_choice(name="Light Purple", value="light_purple"),
        create_choice(name="Dark Purple", value="dark_purple"),
        create_choice(name="White", value="white"),
        create_choice(name="Gray", value="gray"),
        create_choice(name="Dark Gray", value="dark_gray"),
...
ign = create_option(
    name="ign", description="player's ign", required=True, option_type=3
)
